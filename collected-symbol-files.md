...
[iOS system symbol files(10.3.2-11.0)](https://drive.google.com/drive/folders/0B9ItUz-PHtRLb3hidV9kUGJUMkE?usp=sharing)
...
There are 58 versions from `7.0 (11A465)` to `11.0 (15A372)`(if you count OS version with CPU architecture, it's 141).

Here is the list of symbols from `7.0`to`11.0`, with their CPU architecture version I've got.
