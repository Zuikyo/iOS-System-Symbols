...
There are 98 version from `7.0 (11A465)` to `12.2 (16E227)`(if you count OS version with CPU architecture, it's 201).

Here is the list of symbols from `7.0`to`12.2`, with their CPU architecture version I've got.
